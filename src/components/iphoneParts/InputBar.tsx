...
export default function InputBar({ text }: { text: string }) {
  ...
  return (
    <div className="flex items-center gap-[7px] py-[7px] pr-2 pl-[6px] bg-[#1C1C1E] border-t border-white/10">
      ...
      {/* Text input pill */}
      <div className="flex-1 bg-[#2C2C2E] rounded-[16px] border border-white/10 flex items-center gap-[6px] pl-[10px] pr-2 py-[3px]">
        ...
        {/* Right icon — audio wave when empty, send button (squircle) when typing */}
